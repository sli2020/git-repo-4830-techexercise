...
public class DBConnectionLi {
   ...
   static void getDBConnection() {
      ...
      connection = null;
      try {
         UtilPropLi.loadProperty(servletContext);
   ...
   static String getURL() {
      String url = UtilPropLi.getProp("url");
      System.out.println("[DBG] URL: " + url);
      return url;
   }

   static String getUserName() {
      String usr = UtilPropLi.getProp("user");
      System.out.println("[DBG] URL: " + usr);
      return usr;
   }

   static String getPassword() {
      String pwd = UtilPropLi.getProp("password");
